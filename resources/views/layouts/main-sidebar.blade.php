        ...
        <div class="app-sidebar__user clearfix">
            <div class="dropdown user-pro-body">
                ...
                <?php
                    ...
                    if($user->image == '')
                    {
                        echo "<img alt='user-img' class='avatar avatar-xl brround' src='assets/img/faces/user.png'><span class='avatar-status profile-status bg-green'></span>";
                    }

                    else
                    {
                        echo "<img alt='$user->image' class='avatar avatar-xl brround' src='/storage/$user->image'><span class='avatar-status profile-status bg-green'></span>";
                    }
                ?>
