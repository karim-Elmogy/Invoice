				...
				<div class="container-fluid">
					<div class="main-header-left ">
						...
						<div class="main-header-center mr-3 d-sm-none d-md-none d-lg-block">
							<input class="form-control" placeholder="البحث " type="search"> <button class="btn"><i class="fas fa-search d-none d-md-block"></i></button>
						</div>
					</div>
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<div class="dropdown nav-item main-header-notification">
								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										...
										<p class="dropdown-title-text subtext mt-2 mb-0 text-white op-6 pb-0 tx-12 ">
                                            ...
                                            <div class="main-notification-list Notification-scroll">
                                                <a class="d-flex p-3 border-bottom"
                                                   href="{{ url('InvoicesDetails') }}/{{ $notification->data['id'] }}">
                                                    <div class="notifyimg">
                                                        <img alt="user-img" class="avatar avatar-sm brround" src="{{URL::asset('assets/img/faces/user.png')}}">
                                                    </div>
                                                    <div class="mr-3">
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
                             ...
                             <?php
                                    ...
                                    if($user->image == '')
                                    {
                                        echo "<a class='profile-user d-flex' href=''><img  src='assets/img/faces/user.png'></a>";
                                    }

                                    else
                                    {
                                        echo "<a class='profile-user d-flex' href=''><img  src='/storage/$user->image'></a>";
                                    }
                             ?>
								...
								<div class="dropdown-menu">
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
                                            ...
                                            <?php
                                                    ...
                                                    if($user->image == '')
                                                    {
                                                        echo "<img  src='assets/img/faces/user.png' >";
                                                    }

                                                    else
                                                    {
                                                        echo "<img  src='/storage/$user->image' alt='$user->image' >";
                                                    }
                                            ?>
									...
									<a class="dropdown-item" href="{{route('profiles.index')}}"><i class="bx bx-user-circle"></i> Edit Profile</a>
